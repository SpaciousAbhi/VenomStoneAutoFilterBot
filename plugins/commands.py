...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton("<b>➕️ Add me to your chat! ➕</b>", url=f"http://t.me/{temp.U_NAME}?startgroup=true")
            ],[
            InlineKeyboardButton("<b>Search 🔎</b>", switch_inline_query_current_chat=''), 
            InlineKeyboardButton("<b>Channel 🔈</b>", url="https://t.me/VenomStoneNetwork")
            ],[      
            InlineKeyboardButton("<b>Help 🕸️</b>", callback_data="help"),
            InlineKeyboardButton("<b>About ✨</b>", callback_data="about")
        ]]
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        try:
            ...
            return
        btn = [[InlineKeyboardButton("Jᴏɪɴ Mʏ Cʜᴀɴɴᴇʟ ✨", url=https://t.me/VenomStoneNetwork)]]
